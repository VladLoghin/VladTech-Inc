    ...
    () => [
        ...
        fields: [
          ...
          },
          {
            ...
            options: [
              ...
              {
                value: 'FIBER_CEMENT',
                label: t?.sidingMaterialOptions?.FIBER_CEMENT ?? 'Fiber Cement',
              },
              { value: 'BRICK', label: t?.sidingMaterialOptions?.BRICK ?? 'Brick' },
              {
                value: 'STONE_VENEER',
                label: t?.sidingMaterialOptions?.STONE_VENEER ?? 'Stone Veneer',
              },
            ],
          },
          {
          ...
          },
          {
            ...
            label: t.includeInsulation ?? 'Include Insulation',
            type: 'checkbox',
            required: false,
          },
        ],
      },
      {
        ...
        fields: [
          ...
          {
            name: 'tearOffRequired',
            label: t.tearOffRequired ?? 'Tear Off Required',
            type: 'checkbox',
            required: false,
          },
          {
            name: 'hasSkylights',
            label: t.hasSkylights ?? 'Has Skylights',
            type: 'checkbox',
            required: false,
          },
          {
            name: 'numSkylights',
            label: t.numSkylights ?? 'Number of Skylights',
            type: 'number',
            required: false,
            min: 0,
          },
        ...
        fields: [
          ...
          },
          {
            ...
            options: [
              ...
              {
                value: 'SEMI_CUSTOM',
                label: t?.cabinetQualityOptions?.SEMI_CUSTOM ?? 'Semi-Custom',
              },
          ...
          },
          {
            ...
            options: [
              ...
              {
                value: 'BUTCHERBLOCK',
                label: t?.countertopMaterialOptions?.BUTCHERBLOCK ?? 'Butcherblock',
              },
              ...
              { value: 'CONCRETE', label: t?.countertopMaterialOptions?.CONCRETE ?? 'Concrete' },
              {
                ...
                label: t?.countertopMaterialOptions?.STAINLESS_STEEL ?? 'Stainless Steel',
              },
              {
                value: 'SOLID_SURFACE',
                label: t?.countertopMaterialOptions?.SOLID_SURFACE ?? 'Solid Surface',
              },
          ...
          },
          {
            ...
            options: [
              { value: 'HARDWOOD', label: t?.flooringMaterialOptions?.HARDWOOD ?? 'Hardwood' },
              {
                ...
                label: t?.flooringMaterialOptions?.ENGINEERED_HARDWOOD ?? 'Engineered Hardwood',
              },
              ...
              { value: 'CARPET', label: t?.flooringMaterialOptions?.CARPET ?? 'Carpet' },
              {
                ...
                label: t?.flooringMaterialOptions?.POLISHED_CONCRETE ?? 'Polished Concrete',
              },
            ],
          },
          {
            name: 'includeApplianceAllowance',
            label: t.includeApplianceAllowance ?? 'Include Appliance Allowance',
            type: 'checkbox',
            required: false,
          },
          {
            name: 'applianceAllowance',
            label: t.applianceAllowance ?? 'Appliance Allowance',
            type: 'number',
            required: false,
            min: 0,
            step: '0.01',
          ...
          {selectedPreset && (
            <form onSubmit={handleSubmit}>
              {selectedPreset.fields.map((field) => {
                ...
                if (field.name === 'applianceAllowance' && !formData.includeApplianceAllowance)
                  return null;
                return (
                  <div key={field.name}>
