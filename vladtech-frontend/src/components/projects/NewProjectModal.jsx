      ...
      <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex justify-center items-center z-50">
        <div className="bg-white border-2 border-yellow-400 rounded-2xl p-8 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto shadow-2xl">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-5">
              <label className="block text-sm font-semibold text-black mb-2">Employees</label>
            ...
            <div className="mb-5">
              ...
              />
              {errors.dueDate && (
                <span className="text-red-600 text-sm mt-1 block">{errors.dueDate}</span>
              )}
            </div>
            ...
            <div className="mb-5">
              ...
              {errors.projectType && (
                <span className="text-red-600 text-sm mt-1 block">{errors.projectType}</span>
              )}
            </div>
