    ...
    <div className="min-h-screen bg-white">
            ...
            >
              <span
                className={`absolute left-2 text-xs font-semibold transition-all ${
                  language === 'en' ? (isNavbarDark ? 'text-white' : 'text-black') : 'text-gray-400'
                }`}
              >
                EN
              </span>
              ...
              <span
                className={`absolute right-2 text-xs font-semibold transition-all ${
                  language === 'fr' ? (isNavbarDark ? 'text-white' : 'text-black') : 'text-gray-400'
                }`}
              >
                FR
              </span>
      ...
      <div className="relative min-h-screen bg-white flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="container mx-auto px-8 relative">
          ...
          >
            <p className="text-xl md:text-2xl text-black/70 tracking-wide">{t('home.yourIdeas')}</p>
          </motion.div>
