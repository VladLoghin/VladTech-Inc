...
class ReviewResponseMapperTest {
    ...
    void entityToResponseModel_mapsFields() {
        Review review = new Review("clientX", "apptX", "apptX", "fine", true, Rating.THREE, false);
    ...
    void entityListToResponseModelList_mapsList() {
        Review a = new Review("c1", "a1", "Johnny", "c1", true, Rating.FIVE, false);
        a.setReviewId("r1");
        Review b = new Review("c2", "a2", "Lenny", "c2", true, Rating.TWO, false);
        b.setReviewId("r2");
