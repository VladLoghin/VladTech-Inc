...
class ReviewResponseMapperTest {
    ...
    void entityToResponseModel_mapsFields() {
        Review review = new Review("clientX", "apptX", "apptX", "fine", true, Rating.THREE, false, "Interior");
    ...
    void entityListToResponseModelList_mapsList() {
        Review a = new Review("c1", "a1", "Johnny", "c1", true, Rating.FIVE, false, "Interior");
        a.setReviewId("r1");
        Review b = new Review("c2", "a2", "Lenny", "c2", true, Rating.TWO, false, "Interior");
        b.setReviewId("r2");
