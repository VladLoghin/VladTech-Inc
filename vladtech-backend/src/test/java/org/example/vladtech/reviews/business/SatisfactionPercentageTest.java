...
class SatisfactionPercentageTest {
    ...
    void testComputeSatisfactionPercentage_AllFiveStars() {
        // Given
        Review review1 = new Review("client1", "apt1", "John", "Great!", true, Rating.FIVE);
        Review review2 = new Review("client2", "apt2", "Jane", "Excellent!", true, Rating.FIVE);
        Review review3 = new Review("client3", "apt3", "Bob", "Perfect!", true, Rating.FIVE);
    ...
    void testComputeSatisfactionPercentage_AllOneStars() {
        // Given
        Review review1 = new Review("client1", "apt1", "John", "Bad", true, Rating.ONE);
        Review review2 = new Review("client2", "apt2", "Jane", "Terrible", true, Rating.ONE);
    ...
    void testComputeSatisfactionPercentage_MixedRatings() {
        ...
        Review review1 = new Review("client1", "apt1", "John", "Excellent", true, Rating.FIVE);
        Review review2 = new Review("client2", "apt2", "Jane", "Good", true, Rating.FOUR);
        Review review3 = new Review("client3", "apt3", "Bob", "Average", true, Rating.THREE);
        Review review4 = new Review("client4", "apt4", "Alice", "Below", true, Rating.TWO);
        Review review5 = new Review("client5", "apt5", "Tom", "Poor", true, Rating.ONE);
    ...
    void testComputeSatisfactionPercentage_FourPointFiveAverage() {
        ...
        Review review1 = new Review("client1", "apt1", "John", "Excellent", true, Rating.FIVE);
        Review review2 = new Review("client2", "apt2", "Jane", "Excellent", true, Rating.FIVE);
        Review review3 = new Review("client3", "apt3", "Bob", "Good", true, Rating.FOUR);
        Review review4 = new Review("client4", "apt4", "Alice", "Good", true, Rating.FOUR);
        Review review5 = new Review("client5", "apt5", "Tom", "Excellent", true, Rating.FIVE);
