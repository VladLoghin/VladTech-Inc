...
class SatisfactionPercentageTest {
    ...
    void testComputeSatisfactionPercentage_AllFiveStars() {
        // Given
        Review review1 = new Review("client1", "apt1", "John", "Great!", true, Rating.FIVE, false);
        Review review2 = new Review("client2", "apt2", "Jane", "Excellent!", true, Rating.FIVE, false);
        Review review3 = new Review("client3", "apt3", "Bob", "Perfect!", true, Rating.FIVE, false);
    ...
    void testComputeSatisfactionPercentage_AllOneStars() {
        // Given
        Review review1 = new Review("client1", "apt1", "John", "Bad", true, Rating.ONE, false);
        Review review2 = new Review("client2", "apt2", "Jane", "Terrible", true, Rating.ONE, false);
    ...
    void testComputeSatisfactionPercentage_MixedRatings() {
        ...
        Review review1 = new Review("client1", "apt1", "John", "Excellent", true, Rating.FIVE, false);
        Review review2 = new Review("client2", "apt2", "Jane", "Good", true, Rating.FOUR, false);
        Review review3 = new Review("client3", "apt3", "Bob", "Average", true, Rating.THREE, false);
        Review review4 = new Review("client4", "apt4", "Alice", "Below", true, Rating.TWO, false);
        Review review5 = new Review("client5", "apt5", "Tom", "Poor", true, Rating.ONE, false);
    ...
    void testComputeSatisfactionPercentage_FourPointFiveAverage() {
        ...
        Review review1 = new Review("client1", "apt1", "John", "Excellent", true, Rating.FIVE, false);
        Review review2 = new Review("client2", "apt2", "Jane", "Excellent", true, Rating.FIVE, false);
        Review review3 = new Review("client3", "apt3", "Bob", "Good", true, Rating.FOUR, false);
        Review review4 = new Review("client4", "apt4", "Alice", "Good", true, Rating.FOUR, false);
        Review review5 = new Review("client5", "apt5", "Tom", "Excellent", true, Rating.FIVE, false);
