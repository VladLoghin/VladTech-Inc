...
class ReviewRepositoryTest {
    ...
    void findByVisibleTrue_returnsOnlyVisibleReviews() {
        Review visibleReview = new Review("c1", "a1", "Ronnie", "visible comment", true, Rating.FIVE, false);
        Review hiddenReview = new Review("c2", "a2", "James", "hidden comment", false, Rating.ONE, false);
